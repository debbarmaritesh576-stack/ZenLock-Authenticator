...
@Composable
fun PageExtractScreen(
    viewModel: PageExtractViewModel = hiltViewModel(),
    onBack: () -> Unit
) {
    ...
    Column(
        ...
        Text("Extract Pages", style = MaterialTheme.typography.headlineMedium)
        ...
        if (fileName.isEmpty()) {
            ...
            Text("Select pages to extract:", style = MaterialTheme.typography.titleSmall)
    ...
    if (isProcessing) {
        ProgressDialog(title = "Extracting", message = "Creating new PDF...")
    }
